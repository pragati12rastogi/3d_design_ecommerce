...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2022 at 05:06 PM
...
CREATE TABLE `tbl_advertisement` (
  ...
  `adv_type` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `adv_photo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `adv_url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `adv_adsense_code` mediumtext COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `tbl_customer` (
  ...
  `cust_cname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_phone` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cust_country` int(11) NOT NULL,
  `cust_address` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `cust_city` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_state` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_zip` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `cust_b_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_b_cname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_b_phone` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cust_b_country` int(11) NOT NULL,
  `cust_b_address` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `cust_b_city` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_b_state` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_b_zip` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `cust_s_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_s_cname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_s_phone` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cust_s_country` int(11) NOT NULL,
  `cust_s_address` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `cust_s_city` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_s_state` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_s_zip` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `cust_shipping_billing_same` int(11) NOT NULL,
  `cust_password` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cust_datetime` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cust_timestamp` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tbl_customer` (`cust_id`, `cust_name`, `cust_cname`, `cust_email`, `cust_phone`, `cust_country`, `cust_address`, `cust_city`, `cust_state`, `cust_zip`, `cust_b_name`, `cust_b_cname`, `cust_b_phone`, `cust_b_country`, `cust_b_address`, `cust_b_city`, `cust_b_state`, `cust_b_zip`, `cust_s_name`, `cust_s_cname`, `cust_s_phone`, `cust_s_country`, `cust_s_address`, `cust_s_city`, `cust_s_state`, `cust_s_zip`, `cust_shipping_billing_same`, `cust_password`, `cust_token`, `cust_datetime`, `cust_timestamp`, `cust_status`) VALUES
(1, 'John Doe', 'ABC', 'customer@gmail.com', '123-123-1233', 230, 'Test Address', 'Test City', 'N/A', '123456', 'John Doe', 'ABC', '123-123-1234', 18, 'Test Address', 'Test City', 'N/A', '123456', 'John Doe', 'ABC', '123-123-1234', 230, 'Test Address', 'Test City', 'N/A', '123456', 0, '81dc9bdb52d04dc20036dbd8313ed055', '', '2018-01-17 09:40:25', '', 1),
(2, 'Peter Smith', 'DEF', 'customer2@gmail.com', '123-123-1234', 230, 'Test Address', 'Test City', 'N/A', '123456', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', 0, '81dc9bdb52d04dc20036dbd8313ed055', '', '2018-01-17 07:11:12', '1516194672', 1),
(3, 'Robert Bent', 'XYZ', 'customer3@gmail.com', '123-123-1235', 230, 'Test Address', 'Test City', 'N/A', '123456', 'Robert Bent', 'XYZ', '123-123-1234', 18, 'Test Address', 'Test City', 'N/A', '123456', 'Robert Bent', 'XYZ', '123-123-1234', 230, 'Test Address', 'Test City', 'N/A', '123456', 0, '1c0cf8531727fc9b407e5b40ec203338', '', '2018-02-06 11:44:27', '1517895867', 1);
...
CREATE TABLE `tbl_customer_message` (
  ...
  `order_detail` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `cust_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `tbl_end_category` (
  ...
  `ecat_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'Sample 1', 'file-1.jpg'),
(2, 'Sample 2', 'file-2.docx'),
(3, 'Sample 3', 'file-3.pdf');
...
CREATE TABLE `tbl_language` (
  ...
  `lang_value` mediumtext COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'SHIPPING_STATUS', 'Shipping Status'),
(2, 'SEARCH_PRODUCT', 'Search Product'),
(3, 'SEARCH', 'Search'),
(4, 'SUBMIT', 'Submit'),
(5, 'UPDATE', 'Update'),
...
(8, 'PHOTO', 'Photo'),
(9, 'LOGIN', 'Login'),
(10, 'CUSTOMER_LOGIN', 'Customer Login'),
(11, 'CLICK_HERE_TO_LOGIN', 'Click here to login'),
(12, 'BACK_TO_LOGIN_PAGE', 'Back to Login Page'),
(13, 'LOGGED_IN_AS', 'Logged in as'),
(14, 'LOGOUT', 'Logout'),
(15, 'REGISTER', 'Register'),
(16, 'CUSTOMER_REGISTRATION', 'Customer Registration'),
(17, 'REGISTRATION_SUCCESSFUL', 'Registration Successful'),
(18, 'CART', 'Cart'),
(19, 'VIEW_CART', 'View Cart'),
(20, 'UPDATE_CART', 'Update Cart'),
(21, 'BACK_TO_CART', 'Back to Cart'),
(22, 'CHECKOUT', 'Checkout'),
(23, 'PROCEED_TO_CHECKOUT', 'Proceed to Checkout'),
(24, 'ORDERS', 'Orders'),
(25, 'ORDER_HISTORY', 'Order History'),
(26, 'ORDER_DETAILS', 'Order Details'),
(27, 'PAYMENT_DATE_AND_TIME', 'Payment Date and Time'),
(28, 'TRANSACTION_ID', 'Transaction ID'),
(29, 'PAID_AMOUNT', 'Paid Amount'),
(30, 'PAYMENT_STATUS', 'Payment Status'),
(31, 'PAYMENT_METHOD', 'Payment Method'),
(32, 'PAYMENT_ID', 'Payment ID'),
(33, 'PAYMENT_SECTION', 'Payment Section'),
(34, 'SELECT_PAYMENT_METHOD', 'Select Payment Method'),
(35, 'SELECT_A_METHOD', 'Select a Method'),
(36, 'PAYPAL', 'PayPal'),
(37, 'STRIPE', 'Stripe'),
(38, 'BANK_DEPOSIT', 'Bank Deposit'),
(39, 'CARD_NUMBER', 'Card Number'),
(40, 'CVV', 'CVV'),
(41, 'MONTH', 'Month'),
(42, 'YEAR', 'Year'),
(43, 'SEND_TO_THIS_DETAILS', 'Send to this Details'),
(44, 'TRANSACTION_INFORMATION', 'Transaction Information'),
(45, 'INCLUDE_TXN_ID_AND_OTHER_INFORMATION_CORRECTLY', 'Include transaction id and other information correctly'),
(46, 'PAY_NOW', 'Pay Now'),
(47, 'PRODUCT_NAME', 'Product Name'),
(48, 'PRODUCT_DETAILS', 'Product Details'),
(49, 'CATEGORIES', 'Categories'),
(50, 'CATEGORY_COLON', 'Category:'),
(51, 'ALL_PRODUCTS_UNDER', 'All Products Under'),
(52, 'SELECT_SIZE', 'Select Size'),
(53, 'SELECT_COLOR', 'Select Color'),
(54, 'PRODUCT_PRICE', 'Product Price'),
(55, 'QUANTITY', 'Quantity'),
(56, 'OUT_OF_STOCK', 'Out of Stock'),
(57, 'SHARE_THIS', 'Share This'),
(58, 'SHARE_THIS_PRODUCT', 'Share This Product'),
(59, 'PRODUCT_DESCRIPTION', 'Product Description'),
(60, 'FEATURES', 'Features'),
(61, 'CONDITIONS', 'Conditions'),
(62, 'RETURN_POLICY', 'Return Policy'),
(63, 'REVIEWS', 'Reviews'),
(64, 'REVIEW', 'Review'),
(65, 'GIVE_A_REVIEW', 'Give a Review'),
(66, 'WRITE_YOUR_COMMENT_OPTIONAL', 'Write your comment (Optional)'),
(67, 'SUBMIT_REVIEW', 'Submit Review'),
(68, 'YOU_ALREADY_HAVE_GIVEN_A_RATING', 'You already have given a rating!'),
(69, 'YOU_MUST_HAVE_TO_LOGIN_TO_GIVE_A_REVIEW', 'You must have to login to give a review'),
(70, 'NO_DESCRIPTION_FOUND', 'No description found'),
(71, 'NO_FEATURE_FOUND', 'No feature found'),
(72, 'NO_CONDITION_FOUND', 'No condition found'),
(73, 'NO_RETURN_POLICY_FOUND', 'No return policy found'),
(74, 'NO_REVIEW_FOUND', 'No Review is Found'),
(75, 'CUSTOMER_NAME', 'Customer Name'),
(76, 'COMMENT', 'Comment'),
(77, 'COMMENTS', 'Comments'),
(78, 'RATING', 'Rating'),
(79, 'PREVIOUS', 'Previous'),
(80, 'NEXT', 'Next'),
(81, 'SUBTOTAL', 'Sub Total'),
(82, 'TOTAL', 'Total'),
(83, 'ACTION', 'Action'),
(84, 'SHIPPING_COST', 'Shipping Cost'),
(85, 'CONTINUE_SHOPPING', 'Continue Shopping'),
(86, 'UPDATE_BILLING_ADDRESS', 'Update Billing Address'),
(87, 'UPDATE_SHIPPING_ADDRESS', 'Update Shipping Address'),
(88, 'UPDATE_BILLING_AND_SHIPPING_INFO', 'Update Billing and Shipping Info'),
(89, 'DASHBOARD', 'Dashboard'),
(90, 'WELCOME_TO_THE_DASHBOARD', 'Welcome to the Dashboard'),
(91, 'BACK_TO_DASHBOARD', 'Back to Dashboard'),
(92, 'SUBSCRIBE', 'Subscribe'),
(93, 'SUBSCRIBE_TO_OUR_NEWSLETTER', 'Subscribe To Our Newsletter'),
(94, 'EMAIL_ADDRESS', 'Email Address'),
(95, 'ENTER_YOUR_EMAIL_ADDRESS', 'Enter Your Email Address'),
(96, 'PASSWORD', 'Password'),
(97, 'FORGET_PASSWORD', 'Forget Password'),
(98, 'RETYPE_PASSWORD', 'Retype Password'),
(99, 'UPDATE_PASSWORD', 'Update Password'),
(100, 'NEW_PASSWORD', 'New Password'),
(101, 'RETYPE_NEW_PASSWORD', 'Retype New Password'),
(102, 'FULL_NAME', 'Full Name'),
(103, 'COMPANY_NAME', 'Company Name'),
(104, 'PHONE_NUMBER', 'Phone Number'),
(105, 'ADDRESS', 'Address'),
(106, 'COUNTRY', 'Country'),
(107, 'CITY', 'City'),
(108, 'STATE', 'State'),
(109, 'ZIP_CODE', 'Zip Code'),
(110, 'ABOUT_US', 'About Us'),
(111, 'FEATURED_POSTS', 'Featured Posts'),
(112, 'POPULAR_POSTS', 'Popular Posts'),
(113, 'RECENT_POSTS', 'Recent Posts'),
(114, 'CONTACT_INFORMATION', 'Contact Information'),
(115, 'CONTACT_FORM', 'Contact Form'),
(116, 'OUR_OFFICE', 'Our Office'),
(117, 'UPDATE_PROFILE', 'Update Profile'),
(118, 'SEND_MESSAGE', 'Send Message'),
(119, 'MESSAGE', 'Message'),
(120, 'FIND_US_ON_MAP', 'Find Us On Map'),
(121, 'CONGRATULATION_PAYMENT_IS_SUCCESSFULL', 'Congratulation! Payment is successful.'),
(122, 'BILLING_AND_SHIPPING_INFORMATION_IS_UPDATED_SUCCESSFULLY', 'Billing and Shipping Information is updated successfully.'),
(123, 'CUSTOMER_NAME_CAN_NOT_BE_EMPTY', 'Customer Name can not be empty.'),
(124, 'PHONE_NUMBER_CAN_NOT_BE_EMPTY', 'Phone Number can not be empty.'),
(125, 'ADDRESS_CAN_NOT_BE_EMPTY', 'Address can not be empty.'),
(126, 'YOU_MUST_HAVE_TO_SELECT_A_COUNTRY', 'You must have to select a country.'),
(127, 'CITY_CAN_NOT_BE_EMPTY', 'City can not be empty.'),
(128, 'STATE_CAN_NOT_BE_EMPTY', 'State can not be empty.'),
(129, 'ZIP_CODE_CAN_NOT_BE_EMPTY', 'Zip Code can not be empty.'),
(130, 'PROFILE_INFORMATION_IS_UPDATED_SUCCESSFULLY', 'Profile Information is updated successfully.'),
(131, 'EMAIL_ADDRESS_CAN_NOT_BE_EMPTY', 'Email Address can not be empty'),
(132, 'EMAIL_AND_OR_PASSWORD_CAN_NOT_BE_EMPTY', 'Email and/or Password can not be empty.'),
(133, 'EMAIL_ADDRESS_DOES_NOT_MATCH', 'Email Address does not match.'),
(134, 'EMAIL_ADDRESS_MUST_BE_VALID', 'Email address must be valid.'),
(135, 'EMAIL_ADDRESS_IS_NOT_FOUND_IN_OUR_SYSTEM', 'You email address is not found in our system.'),
(136, 'PLEASE_CHECK_YOUR_EMAIL_AND_CONFIRM_SUBSCRIPTION', 'Please check your email and confirm your subscription.'),
(137, 'YOUR_EMAIL_IS_VERIFIED_SUCCESSFULLY_YOU_CAN_NOW_LOGIN_TO_OUR_WEBSITE', 'Your email is verified successfully. You can now login to our website.'),
(138, 'PASSWORD_CAN_NOT_BE_EMPTY', 'Password can not be empty.'),
(139, 'PASSWORDS_DO_NOT_MATCH', 'Passwords do not match.'),
(140, 'PLEASE_ENTER_NEW_AND_RETYPE_PASSWORDS', 'Please enter new and retype passwords.'),
(141, 'PASSWORD_IS_UPDATED_SUCCESSFULLY', 'Password is updated successfully.'),
(142, 'TO_RESET_PASSWORD_PLEASE_CLICK_ON_LINK_BELOW', 'To reset your password, please click on the link below.'),
(143, 'PASSWORD_RESET_REQUEST', 'Password Reset Request'),
(144, 'PASSWORD_RESET_TIME_EXPIRE_MESSAGE', 'The password reset email time (24 hours) has expired. Please again try to reset your password.'),
(145, 'PASSWORD_RESET_SENT_MESSAGE', 'A confirmation link is sent to your email address. You will get the password reset information in there.'),
(164, 'SELECT_COUNTRY', 'Select Country'),
(146, 'PASSWORD_RESET_SUCCESS_MESSAGE', 'Password is reset successfully. You can now login.'),
(147, 'EMAIL_ADDRESS_ALREADY_EXISTS', 'Email Address Already Exists.'),
(148, 'ACCOUNT_INACTIVE_MESSAGE', 'Sorry! Your account is inactive. Please contact to the administrator.'),
(149, 'CHANGE_PASSWORD', 'Change Password'),
(150, 'REGISTRATION_EMAIL_CONFIRMATION', 'Registration Email Confirmation'),
(151, 'REGISTRATION_COMPLETION_MESSAGE_IN_EMAIL', 'Thank you for your registration! Your account has been created. To active your account click on the link below:'),
(152, 'REGISTRATION_COMPLETION_MESSAGE', 'Your registration is completed. Please check your email address to follow the process to confirm your registration.'),
(153, 'NO_PRODUCT_FOUND', 'No Product Found'),
(154, 'ADD_TO_CART', 'Add to Cart'),
(155, 'RELATED_PRODUCTS', 'Related Products'),
(156, 'SEE_ALL_RELATED_PRODUCTS_FROM_BELOW', 'See all the related products from below'),
(157, 'SIZE', 'Size'),
(158, 'COLOR', 'Color'),
(159, 'PRICE', 'Price'),
(160, 'PLEASE_LOGIN_AS_CUSTOMER_TO_CHECKOUT', 'Please login as customer to checkout'),
(161, 'BILLING_ADDRESS', 'Billing Address'),
(162, 'SHIPPING_ADDRESS', 'Shipping Address'),
(163, 'RATING_IS_SUBMITTED_SUCCESSFULLY', 'Rating is Submitted Successfully!'),
(165, 'CASH_ON_DELIVERY', 'Cash On Delivery'),
(166, 'CONGRATULATION_CASH_ON_DELIVERY', 'Thank you for the order request! Your item will be delivered soon.'),
(167, 'PHONE_NUMBER_ALREADY_EXIST', 'Phone Number Already Exists.');
...
CREATE TABLE `tbl_mid_category` (
  `mcat_id` int(11) NOT NULL,
  `mcat_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
(4, 66, 'Gold Leather High Heel For Women', '35', 'Gold', '1', '21', '1571073875'),
(5, 30, 'Le Reve Pink Cotton Top for Women', 'XS', 'Pink', '2', '31', '1571109331'),
(6, 31, 'China Georgette Casual Long Sleeves Tops', '46', 'Mixed', '3', '40', '1587701701'),
(7, 6, 'Pant 1', 'XS', 'White', '1', '12', '1587701701'),
(8, 4, 'Charismatic Red Cotton T-shirt for Men', '', 'Red', '2', '10', '1587702778');
...
CREATE TABLE `tbl_page` (
  ...
  `about_meta_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `about_meta_keyword` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `about_meta_description` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `faq_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `faq_banner` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `faq_meta_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `faq_meta_keyword` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `faq_meta_description` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `blog_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `blog_banner` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `blog_meta_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `blog_meta_keyword` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `blog_meta_description` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `contact_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `contact_banner` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `contact_meta_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `contact_meta_keyword` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `contact_meta_description` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `pgallery_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `pgallery_banner` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `pgallery_meta_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `pgallery_meta_keyword` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `pgallery_meta_description` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `vgallery_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `vgallery_banner` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `vgallery_meta_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `vgallery_meta_keyword` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `vgallery_meta_description` mediumtext COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `tbl_payment` (
  ...
  `card_cvv` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `card_month` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `card_year` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `bank_transaction_info` mediumtext COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tbl_payment` (`id`, `customer_id`, `customer_name`, `customer_email`, `customer_phone`, `payment_date`, `txnid`, `paid_amount`, `card_number`, `card_cvv`, `card_month`, `card_year`, `bank_transaction_info`, `payment_method`, `currency`, `payment_status`, `shipping_status`, `payment_id`) VALUES
(5, 7, 'John Doe', 'customer@gmail.com', '123-123-1233', '2019-10-15 09:15:31', 'ch_1FTgVUBoKopKik6AS3xFvKf1', 67, '4242424242424242', '234', '10', '2020', '', 'Stripe', 'USD', 'Completed', 'Pending', '1571109331'),
(4, 7, 'John Doe', 'customer@gmail.com', '123-123-1233', '2019-10-14 23:24:35', '', 26, '', '', '', '', '', 'Cash On Delivery', 'USD', 'Completed', 'N/A', '1571073875'),
(6, 1, 'John Doe', 'customer@gmail.com', '123-123-1233', '2020-04-24 10:15:01', 'ch_1GbIvcBoKopKik6ATOH43mzs', 142, '4242424242424242', '234', '09', '2020', '', 'Stripe', 'USD', 'Completed', 'Pending', '1587701701'),
(7, 1, 'John Doe', 'customer@gmail.com', '123-123-1233', '2020-04-24 10:32:58', 'ch_1GbJCyBoKopKik6AMaS5wsK2', 30, '4242424242424242', '333', '09', '2020', '', 'Stripe', 'EUR', 'Completed', 'Pending', '1587702778');
...
CREATE TABLE `tbl_product` (
  ...
  `p_old_price` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `p_current_price` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `p_qty` int(10) NOT NULL,
  `p_featured_photo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `p_description` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `p_short_description` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `p_feature` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `p_condition` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `p_return_policy` mediumtext COLLATE utf8_unicode_ci NOT NULL,
...
(13, 'Tan Denim Chino Pant For Men', '', '20', 45, 'product-featured-13.jpg', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis. Duo volutpat imperdiet ut, postea salutatus imperdiet ut per, ad utinam debitis invenire has.</p>\r\n\r\n<p>Liber utroque vim an, ne his brute vivendo, est fabulas consetetur appellantur an. In dolore legendos quo, ne ferri noluisse sed. Tantas eligendi at ius. Purto ipsum nemore sit ad.</p>\r\n\r\n<p>Vix tale noluisse voluptua ad, ne brute altera democritum cum. Omnes ornatus qui et, te aeterno discere ocurreret sea. Tollit cetero cu usu, etiam evertitur id nec. Id pro unum pertinax oportere, vel ad ridens mollis. Ad ius meis suavitate voluptaria.</p>\r\n\r\n<p>Mei ut errem legimus periculis, eos liber epicurei necessitatibus eu, facilisi postulant vel no. Ad mea commune disputando, cu vel choro exerci. Pri et oratio iisque atomorum, enim detracto mei ne, id eos soleat iudicabit. Ne reque reformidans mei, rebum delicata consequuntur an sit. Sea ad audire utamur. Ut mei ridens minimum intellegat, perpetua euripidis te qui, ad consul intellegebat comprehensam eum.</p>\r\n\r\n<p>Ex vix alienum sadipscing, quod melius philosophia id has. Ad qui quem reprimique, quo possit detracto reprimique no, sint reque officiis ei per. Ea regione commune volutpat pro, fabulas facilis omnesque mei ne. Cu unum detracto comprehensam sea, ad vim ancillae principes, ex usu fugit consulatu. Vis te purto equidem voluptatum.</p>\r\n', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis.</p>\r\n', '', '', '', 6, 0, 1, 2),
...
(30, 'Le Reve Pink Cotton Top for Women', '', '31', 28, 'product-featured-30.jpg', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis. Duo volutpat imperdiet ut, postea salutatus imperdiet ut per, ad utinam debitis invenire has.</p>\r\n\r\n<p>Liber utroque vim an, ne his brute vivendo, est fabulas consetetur appellantur an. In dolore legendos quo, ne ferri noluisse sed. Tantas eligendi at ius. Purto ipsum nemore sit ad.</p>\r\n\r\n<p>Vix tale noluisse voluptua ad, ne brute altera democritum cum. Omnes ornatus qui et, te aeterno discere ocurreret sea. Tollit cetero cu usu, etiam evertitur id nec. Id pro unum pertinax oportere, vel ad ridens mollis. Ad ius meis suavitate voluptaria.</p>\r\n\r\n<p>Mei ut errem legimus periculis, eos liber epicurei necessitatibus eu, facilisi postulant vel no. Ad mea commune disputando, cu vel choro exerci. Pri et oratio iisque atomorum, enim detracto mei ne, id eos soleat iudicabit. Ne reque reformidans mei, rebum delicata consequuntur an sit. Sea ad audire utamur. Ut mei ridens minimum intellegat, perpetua euripidis te qui, ad consul intellegebat comprehensam eum.</p>\r\n\r\n<p>Ex vix alienum sadipscing, quod melius philosophia id has. Ad qui quem reprimique, quo possit detracto reprimique no, sint reque officiis ei per. Ea regione commune volutpat pro, fabulas facilis omnesque mei ne. Cu unum detracto comprehensam sea, ad vim ancillae principes, ex usu fugit consulatu. Vis te purto equidem voluptatum.</p>\r\n', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis.</p>\r\n', '', '', '', 27, 0, 1, 6),
(31, 'China Georgette Casual Long Sleeves Tops', '', '40', 34, 'product-featured-31.jpg', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis. Duo volutpat imperdiet ut, postea salutatus imperdiet ut per, ad utinam debitis invenire has.</p>\r\n\r\n<p>Liber utroque vim an, ne his brute vivendo, est fabulas consetetur appellantur an. In dolore legendos quo, ne ferri noluisse sed. Tantas eligendi at ius. Purto ipsum nemore sit ad.</p>\r\n\r\n<p>Vix tale noluisse voluptua ad, ne brute altera democritum cum. Omnes ornatus qui et, te aeterno discere ocurreret sea. Tollit cetero cu usu, etiam evertitur id nec. Id pro unum pertinax oportere, vel ad ridens mollis. Ad ius meis suavitate voluptaria.</p>\r\n\r\n<p>Mei ut errem legimus periculis, eos liber epicurei necessitatibus eu, facilisi postulant vel no. Ad mea commune disputando, cu vel choro exerci. Pri et oratio iisque atomorum, enim detracto mei ne, id eos soleat iudicabit. Ne reque reformidans mei, rebum delicata consequuntur an sit. Sea ad audire utamur. Ut mei ridens minimum intellegat, perpetua euripidis te qui, ad consul intellegebat comprehensam eum.</p>\r\n\r\n<p>Ex vix alienum sadipscing, quod melius philosophia id has. Ad qui quem reprimique, quo possit detracto reprimique no, sint reque officiis ei per. Ea regione commune volutpat pro, fabulas facilis omnesque mei ne. Cu unum detracto comprehensam sea, ad vim ancillae principes, ex usu fugit consulatu. Vis te purto equidem voluptatum.</p>\r\n', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis.</p>\r\n', '', '', '', 13, 0, 1, 6),
...
(66, 'Gold Leather High Heel For Women', '', '21', 33, 'product-featured-66.jpg', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis. Duo volutpat imperdiet ut, postea salutatus imperdiet ut per, ad utinam debitis invenire has.</p>\r\n\r\n<p>Liber utroque vim an, ne his brute vivendo, est fabulas consetetur appellantur an. In dolore legendos quo, ne ferri noluisse sed. Tantas eligendi at ius. Purto ipsum nemore sit ad.</p>\r\n\r\n<p>Vix tale noluisse voluptua ad, ne brute altera democritum cum. Omnes ornatus qui et, te aeterno discere ocurreret sea. Tollit cetero cu usu, etiam evertitur id nec. Id pro unum pertinax oportere, vel ad ridens mollis. Ad ius meis suavitate voluptaria.</p>\r\n\r\n<p>Mei ut errem legimus periculis, eos liber epicurei necessitatibus eu, facilisi postulant vel no. Ad mea commune disputando, cu vel choro exerci. Pri et oratio iisque atomorum, enim detracto mei ne, id eos soleat iudicabit. Ne reque reformidans mei, rebum delicata consequuntur an sit. Sea ad audire utamur. Ut mei ridens minimum intellegat, perpetua euripidis te qui, ad consul intellegebat comprehensam eum.</p>\r\n\r\n<p>Ex vix alienum sadipscing, quod melius philosophia id has. Ad qui quem reprimique, quo possit detracto reprimique no, sint reque officiis ei per. Ea regione commune volutpat pro, fabulas facilis omnesque mei ne. Cu unum detracto comprehensam sea, ad vim ancillae principes, ex usu fugit consulatu. Vis te purto equidem voluptatum.</p>\r\n\r\n<p>Detracto contentiones te est, brute ipsum consul an vis. Mea ei regione blandit ullamcorper, definiebas constituam vix ei. At his ludus nonumes gloriatur. Ne vim tamquam nonumes.</p>\r\n', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis.</p>\r\n', '', '', '', 4, 0, 1, 13),
...
--
-- Table structure for table `tbl_setting_advertisement`
--

CREATE TABLE `tbl_setting_advertisement` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_setting_advertisement`
--

INSERT INTO `tbl_setting_advertisement` (`id`, `ads_above_welcome_on_off`, `ads_above_featured_product_on_off`, `ads_above_latest_product_on_off`, `ads_above_popular_product_on_off`, `ads_above_testimonial_on_off`, `ads_category_sidebar_on_off`) VALUES
(1, 1, 1, 1, 1, 1, 1);
...
CREATE TABLE `tbl_setting_banner` (
  ...
  `banner_registration` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `banner_forget_password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `banner_reset_password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `banner_search` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `banner_cart` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `banner_checkout` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `banner_product_category` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `banner_blog` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_setting_banner` (`id`, `banner_login`, `banner_registration`, `banner_forget_password`, `banner_reset_password`, `banner_search`, `banner_cart`, `banner_checkout`, `banner_product_category`, `banner_blog`) VALUES
(1, 'banner_login.jpg', 'banner_registration.jpg', 'banner_forget_password.jpg', 'banner_reset_password.jpg', 'banner_search.jpg', 'banner_cart.jpg', 'banner_checkout.jpg', 'banner_product_category.jpg', 'banner_blog.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_setting_color`
--

CREATE TABLE `tbl_setting_color` (
  `id` int(11) NOT NULL,
  `color` varchar(10) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `tbl_setting_color`
--

INSERT INTO `tbl_setting_color` (`id`, `color`) VALUES
(1, 'E4144D');
...
CREATE TABLE `tbl_setting_currency` (
  ...
  `currency_value_per_usd` varchar(10) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `tbl_setting_currency`
--

INSERT INTO `tbl_setting_currency` (`id`, `currency_code`, `currency_symbol`, `currency_position`, `currency_value_per_usd`) VALUES
(1, 'USD', '$', 'Before', '1');
...
CREATE TABLE `tbl_setting_email` (
  ...
  `smtp_active` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `smtp_ssl` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `smtp_host` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `smtp_port` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `forget_password_message` mediumtext COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_setting_email` (`id`, `send_email_from`, `receive_email_to`, `smtp_active`, `smtp_ssl`, `smtp_host`, `smtp_port`, `smtp_username`, `smtp_password`, `receive_email_subject`, `receive_email_thank_you_message`, `forget_password_message`) VALUES
(1, 'contact@yourwebsite.com', 'youremail@gmail.com', 'Yes', 'Yes', 'smtp_host', 'smtp_port', 'smtp_username', 'smtp_password', 'Visitor Email Message from Ecommerce Website', 'Thank you for sending the email. We will contact you shortly.', 'A confirmation link is sent to your email address. You will get the password reset information in there.');
...
INSERT INTO `tbl_setting_footer` (`id`, `footer_about`, `footer_copyright`, `newsletter_on_off`) VALUES
(1, '<p>Lorem ipsum dolor sit amet, omnis signiferumque in mei, mei ex enim concludaturque. Senserit salutandi euripidis no per, modus maiestatis scribentur est an.&nbsp;Ea suas pertinax has.</p>\r\n', 'Copyright Â© 2019. All Rights Reserved.', 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_setting_head_body`
--

CREATE TABLE `tbl_setting_head_body` (
  `id` int(11) NOT NULL,
  `before_head` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `after_body` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `before_body` mediumtext COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `tbl_setting_head_body`
--

INSERT INTO `tbl_setting_head_body` (`id`, `before_head`, `after_body`, `before_body`) VALUES
(1, '<script async src=\"https://www.googletagmanager.com/gtag/js?id=GA_TRACKING_ID\"></script>\r\n<script>\r\n  window.dataLayer = window.dataLayer || [];\r\n  function gtag(){dataLayer.push(arguments);}\r\n  gtag(\'js\', new Date());\r\n\r\n  gtag(\'config\', \'GA_TRACKING_ID\');\r\n</script>', '<div id=\"fb-root\"></div>\r\n<script>(function(d, s, id) {\r\n  var js, fjs = d.getElementsByTagName(s)[0];\r\n  if (d.getElementById(id)) return;\r\n  js = d.createElement(s); js.id = id;\r\n  js.src = \"//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.10&appId=323620764400430\";\r\n  fjs.parentNode.insertBefore(js, fjs);\r\n}(document, \'script\', \'facebook-jssdk\'));</script>', '<!--Start of Tawk.to Script-->\r\n<script type=\"text/javascript\">\r\nvar Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();\r\n(function(){\r\nvar s1=document.createElement(\"script\"),s0=document.getElementsByTagName(\"script\")[0];\r\ns1.async=true;\r\ns1.src=\'https://embed.tawk.to/5a7c31ded7591465c7077c48/default\';\r\ns1.charset=\'UTF-8\';\r\ns1.setAttribute(\'crossorigin\',\'*\');\r\ns0.parentNode.insertBefore(s1,s0);\r\n})();\r\n</script>\r\n<!--End of Tawk.to Script-->');
...
CREATE TABLE `tbl_setting_home` (
  ...
  `cta_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cta_content` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `cta_read_more_text` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cta_read_more_url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cta_photo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `featured_product_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `featured_product_subtitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `latest_product_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `latest_product_subtitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `popular_product_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `popular_product_subtitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `testimonial_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `testimonial_subtitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `testimonial_photo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `blog_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `blog_subtitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tbl_setting_home` (`id`, `meta_title_home`, `meta_keyword_home`, `meta_description_home`, `cta_title`, `cta_content`, `cta_read_more_text`, `cta_read_more_url`, `cta_photo`, `featured_product_title`, `featured_product_subtitle`, `latest_product_title`, `latest_product_subtitle`, `popular_product_title`, `popular_product_subtitle`, `testimonial_title`, `testimonial_subtitle`, `testimonial_photo`, `blog_title`, `blog_subtitle`, `newsletter_text`, `home_service_on_off`, `home_welcome_on_off`, `home_featured_product_on_off`, `home_latest_product_on_off`, `home_popular_product_on_off`, `home_testimonial_on_off`, `home_blog_on_off`) VALUES
(1, 'Ecommerce - Complete Ecommerce PHP Script', 'ecommerce, cart, checkout, payment, paypal, shop, online shopping, online payment, payment gateway, products, shirt, jeans, t-shirt', 'This is a complete solution of an online ecommerce website.', 'Welcome To Our Ecommerce Website', '', 'Read More', '#', 'cta.jpg', 'Featured Products', 'See all our featured products from here', 'Latest Products', 'See all our latest products from here', 'Popular Products', 'See all our popular products from here', 'Testimonials', 'See what our clients tell about us', 'testimonial.jpg', 'Latest Blog', 'See all our latest articles and news from below', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid fugit expedita, iure ullam cum vero ex sint aperiam maxime.', 1, 1, 1, 1, 1, 1, 1);
...
CREATE TABLE `tbl_setting_payment` (
  `id` int(11) NOT NULL,
  `paypal_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `paypal_email` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `stripe_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `bank_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `bank_detail` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `cash_on_delivery_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_setting_payment` (`id`, `paypal_status`, `paypal_email`, `stripe_status`, `stripe_public_key`, `stripe_secret_key`, `bank_status`, `bank_detail`, `cash_on_delivery_status`) VALUES
(1, 'Active', 'xicia_b@shop.com', 'Active', 'pk_test_0SwMWadgu8DwmEcPdUPRsZ7b', 'sk_test_TFcsLJ7xxUtpALbDo1L5c1PN', 'Active', 'Bank Name: ABC Bank\r\nAccount Number: 1222320234444\r\nBranch Name: NY Branch\r\nCountry: USA', 'Active');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_setting_post`
--

CREATE TABLE `tbl_setting_post` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_setting_post`
--

INSERT INTO `tbl_setting_post` (`id`, `total_recent_post_footer`, `total_popular_post_footer`, `total_recent_post_sidebar`, `total_popular_post_sidebar`, `total_featured_product_home`, `total_latest_product_home`, `total_popular_product_home`) VALUES
(1, 4, 4, 5, 5, 10, 10, 10);
...
(4, 'test1@gmail.com', '2017-08-10', '2017-08-10 07:44:23', '', 1),
(7, 'test2@gmail.com', '2019-10-09', '2019-10-09 10:31:42', '', 1);
...
CREATE TABLE `tbl_top_category` (
  `tcat_id` int(11) NOT NULL,
  `tcat_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tbl_user` (`id`, `full_name`, `email`, `phone`, `password`, `photo`, `role`, `token`, `status`) VALUES
...
CREATE TABLE `tbl_video` (
  `id` int(11) NOT NULL,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `iframe_code` mediumtext COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Indexes for table `tbl_setting_advertisement`
--
ALTER TABLE `tbl_setting_advertisement`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_setting_color`
--
ALTER TABLE `tbl_setting_color`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_setting_currency`
--
ALTER TABLE `tbl_setting_currency`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_setting_head_body`
--
ALTER TABLE `tbl_setting_head_body`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_setting_post`
--
ALTER TABLE `tbl_setting_post`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tbl_language`
  MODIFY `lang_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
...
--
-- AUTO_INCREMENT for table `tbl_setting_advertisement`
--
ALTER TABLE `tbl_setting_advertisement`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_setting_color`
--
ALTER TABLE `tbl_setting_color`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_setting_currency`
--
ALTER TABLE `tbl_setting_currency`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_setting_head_body`
--
ALTER TABLE `tbl_setting_head_body`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_setting_post`
--
ALTER TABLE `tbl_setting_post`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
