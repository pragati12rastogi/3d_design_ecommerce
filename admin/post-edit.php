...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		if($previous_photo != '' && $path != '') {
	    	...
	    	unlink('../public_files/uploads/'.$previous_photo);
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control editor" name="post_content"><?php echo $post_content; ?></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-6" style="padding-top:6px;">
				            	...
				            	if($photo == '') {
				            		...
				            		echo '<img src="../public_files/uploads/'.$photo.'" class="existing-photo" style="width:200px;">';	
				            	}
				            	?>
