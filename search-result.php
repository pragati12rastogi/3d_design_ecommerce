...
<div class="page-banner" style="background-image: url(public_files/uploads/<?php echo $banner_search; ?>);">
...
<div class="page">
    <div class="container">
        <div class="row">
            ...
            $adjacents = 5;
            $statement = $pdo->prepare("SELECT * FROM tbl_product WHERE p_is_active=? and is_delete = 0 AND p_name LIKE ?");
            ...
            $statement = $pdo->prepare("SELECT * FROM tbl_product WHERE p_is_active=? and is_delete = 0 AND p_name LIKE ? LIMIT $start, $limit");
            $statement->execute(array(1,$search_text));
            $result = $statement->fetchAll();
