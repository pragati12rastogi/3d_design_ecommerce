    ...
    $.fn.imageUploader = function (options) {
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', {class: 'image-uploader'}),
                ...
                $i = $('<i>', {class: 'fa fa-upload', text: ''}).appendTo($textContainer),
        ...
        let createImg = function (src, id) {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                $button = $('<button>', {class: 'delete-image','data-id':id}).appendTo($container),

                // Create the delete icon
                $i = $('<i>', {class: 'fa fa-close'}).appendTo($button);
            ...
            $button.on("click", function (e) {
                // Prevent browser default event and stop propagation
                prevent(e);
                deleted_photos.push($(this).attr('data-id'));
                
                $(document).find("#deleted_photo").val(deleted_photos.join());
