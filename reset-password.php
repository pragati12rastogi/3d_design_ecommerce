...
{
    $error_message2 = PASSWORD_RESET_TIME_EXPIRE_MESSAGE;
}
...
if(isset($_POST['form1'])) {
    ...
    {
        $valid = 0;
        $error_message .= PLEASE_ENTER_NEW_AND_RETYPE_PASSWORDS.'\\n';
    }
    else
    {
...
<div class="page-banner" style="background-color:#444;background-image: url(public_files/uploads/<?php echo $banner_reset_password; ?>);">
    <div class="inner">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for=""></label>
                                        <input type="submit" class="btn btn-primary" value="<?php echo CHANGE_PASSWORD; ?>" name="form1">
                                    </div>
                                </div>
                            </div>                        
                        </form>
