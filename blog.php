...
<div class="page-banner" style="background-image: url(public_files/uploads/<?php echo $blog_banner; ?>);">
    <div class="inner">
        <h1>Blog</h1>
    </div>
</div>
                            ...
                            foreach ($result as $row) {
                                ...
                                <div class="post-item">
                                    <div class="image-holder">
                                        <img class="img-responsive" src="public_files/uploads/<?php echo $row['photo']; ?>" alt="<?php echo $row['post_title']; ?>">
                                    </div>
                                    <div class="text">
                                        <div class="inner">
